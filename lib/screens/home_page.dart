...
class HomePage extends StatelessWidget {
          ...
          children: [
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: const DecorationImage(
                    image: NetworkImage(
                        'https://placehold.co/600x150/FF6347/FFFFFF?text=Mega+Sale+Banner'),
                    fit: BoxFit.cover,
                  ),
                ),
                child: Stack(
                    ...
                    Positioned(
                      ...
                      child: CircleAvatar(
                        ...
                        backgroundImage: const NetworkImage(
                            'https://placehold.co/60x60/FFFFFF/000000?text=User'),
                      ),
                    ),
                  ],
                ),
            ...
            Padding(
              ...
              child: Wrap(
                ...
                children: [
                  _buildCategoryItem(Icons.flash_on, 'Flash Sale', screenWidth, screenHeight, textScaleFactor), // Pass screenHeight
                  _buildCategoryItem(Icons.card_giftcard, 'Voucher', screenWidth, screenHeight, textScaleFactor), // Pass screenHeight
                  _buildCategoryItem(Icons.local_shipping, 'Delivery', screenWidth, screenHeight, textScaleFactor), // Pass screenHeight
                  _buildCategoryItem(Icons.devices, 'Gadget', screenWidth, screenHeight, textScaleFactor), // Pass screenHeight
                  _buildCategoryItem(Icons.more_horiz, 'More', screenWidth, screenHeight, textScaleFactor), // Pass screenHeight
                ],
              ),
            ),

            // Featured Products Section
            _buildSectionHeader('Featured Product', 'View All', screenWidth, textScaleFactor, context, screenHeight), // Pass screenHeight
            SizedBox(
              ...
              child: ListView(
                ...
                children: [
                  _buildProductCard(
                    context,
                    'TMX 210 Wireless',
                    'https://placehold.co/150x150/E0E0E0/000000?text=Headphones',
                    'Rp 1.000.000',
                    'Rp 750.000',
                    '25%',
                    screenWidth,
            ...
            _buildSectionHeader('Best Sellers', 'View All', screenWidth, textScaleFactor, context, screenHeight), // Pass screenHeight
            SizedBox(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  _buildProductCard(
                    context,
                    'TMX 210 Wireless',
                    'https://placehold.co/150x150/E0E0E0/000000?text=Drill',
                    'Rp 1.000.000',
                    'Rp 750.000',
                    '25%',
                    screenWidth,
            ...
            _buildSectionHeader('New Arrivals', 'View All', screenWidth, textScaleFactor, context, screenHeight), // Pass screenHeight
            Padding(
              padding: EdgeInsets.symmetric(horizontal: screenWidth * 0.04),
              child: Column(
                children: [
                  _buildNewsCard(
                    ...
                    'https://placehold.co/100x80/CCCCCC/000000?text=News1',
                    screenWidth,
                    screenHeight, // Pass screenHeight
                    textScaleFactor,
                  ),
                  _buildNewsCard(
                    ...
                    'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
                    'https://placehold.co/100x80/CCCCCC/000000?text=News2',
                    screenWidth,
                    screenHeight, // Pass screenHeight
                    textScaleFactor,
                  ),
                  _buildNewsCard(
                    ...
                    'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
                    'https://placehold.co/100x80/CCCCCC/000000?text=News3',
                    screenWidth,
                    screenHeight, // Pass screenHeight
                    textScaleFactor,
                  ),
  ...
  Widget _buildCategoryItem(IconData icon, String label, double screenWidth, double screenHeight, double textScaleFactor) {
    return Column(
      children: [
        ...
        SizedBox(height: screenHeight * 0.008), // Pass screenHeight here
        Text(
          label,
  ...
  Widget _buildSectionHeader(String title, String actionText, double screenWidth, double textScaleFactor, BuildContext context, double screenHeight) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: screenWidth * 0.04, vertical: screenHeight * 0.015), // Pass screenHeight here
      child: Row(
        ...
        children: [
          ...
          TextButton(
            onPressed: () {
              ...
              // context.go('/category/${title.toLowerCase().replaceAll(' ', '_')}');
            },
            child: Text(
              actionText,
  ...
  Widget _buildProductCard(
      ...
      String discount,
      double screenWidth,
      double screenHeight, // Pass screenHeight here
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: screenHeight * 0.005), // Pass screenHeight here
                  Text(
                    oldPrice,
                    style: TextStyle(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                        padding: EdgeInsets.symmetric(horizontal: screenWidth * 0.015, vertical: screenHeight * 0.003), // Pass screenHeight here
                        decoration: BoxDecoration(
  ...
  Widget _buildNewsCard(
      String title, String description, String imageUrl, double screenWidth, double screenHeight, double textScaleFactor) { // Pass screenHeight here
    return Padding(
      padding: EdgeInsets.symmetric(vertical: screenHeight * 0.01), // Pass screenHeight here
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ClipRRect(
